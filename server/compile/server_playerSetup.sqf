...
_playerObj addMPEventHandler ["MPHit", {_this call fnc_plyrHit;}];
_playerObj addMPEventHandler ["MPKilled", {_this spawn fnc_playerDied;}];
...
_primary2 = [_key2,""+server_var+"HIVE"] call server_hiveReadWrite;
