...
if (!isNull _playerObj) then {
	...
	if ((_timeout - time) > 0) then {
		...
		_hint = parseText format["<t align='center' color='#FF0000' shadow='2' size='1.75'>Combat Logger</t><br/><t align='center' color='#ffffff'>%1 has just combat logged at %2.</t>",_playerName,(mapGridPosition _playerObj)];
		[[""+server_var+"","all"],"rHint",_hint] call server_sendremoteExe;
	};
