...
_msgstart = "A group of other survivors have recovered a new vehicle. You want to make it yours?";
_msgwin = "Survivors have killed all the humans to claim the vehicle!";
_msgfail = "The group of survivors have pushed along!";
_colour = "#FF8800";
...
/****************************************** VEHICLE CONFIG ******************************************/
_vehclass = civ_vehicles_hive call BIS_fnc_selectRandom;
...
_u1 = [[_position select 0, _position select 1, 0],4,1,"Random",5,"","Survivor2_DZ","Random",true] call spawn_group;
_u2 = [[_position select 0, _position select 1, 0],4,1,"Random",4,"","SurvivorWcombat_DZ","Random",true] call spawn_group;
_u3 = [[_position select 0, _position select 1, 0],1,1,"Random",4,"","SurvivorW2_DZ","Random",true,_keySelected] call spawn_group;
_u4 = [[_position select 0, _position select 1, 0],1,1,"Random",4,"","SurvivorW2_DZ","Random",true,_keySelected] call spawn_group;

_s1 = [[[(_position select 0) - 10, (_position select 1) - 10, 0]],"M2StaticMG",0.8,"Survivor2_DZ",1,2,"","Random",true] call spawn_static;
_s2 = [[[(_position select 0) + 10, (_position select 1) + 10, 0]],"M2StaticMG",0.8,"Survivor2_DZ",1,2,"","Random",true] call spawn_static;
_s3 = [[[(_position select 0) - 10, (_position select 1) + 10, 0]],"TOW_TriPod_US_EP1",0.8,"Survivor2_DZ",1,2,"","Random",true] call spawn_static;
_s4 = [[[(_position select 0) + 10, (_position select 1) - 10, 0]],"TOW_TriPod_US_EP1",0.8,"Survivor2_DZ",1,2,"","Random",true] call spawn_static;
