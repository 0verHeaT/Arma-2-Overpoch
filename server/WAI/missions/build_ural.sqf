...
_objects = [];
/******************************************* BASIC CONFIG *******************************************/
_name = "Building Supply Mission";
_markercolour = "ColorGreen";
_msgstart = "Bandits have destroyed a Ural carrying building supplies and are securing the cargo! Kill the Bandits and grab the loot!";
_msgwin = "The building stuff has been secured by survivors!";
_msgfail = "Survivors did not secure the building stuff in time!";
_colour = "#00FF00";
...
_u1 = [[_position select 0, _position select 1, 0],4,1,"Random",3,"","","Random",true] call spawn_group;
_u2 = [[_position select 0, _position select 1, 0],4,1,"Random",4,"","","Random",true] call spawn_group;
_u3 = [[_position select 0, _position select 1, 0],4,1,"Random",3,"","","Random",true] call spawn_group;
