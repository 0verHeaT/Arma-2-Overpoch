if (!isDedicated) then {
	...
	call compile preprocessFileLineNumbers "overheat\external\logistic\config.sqf";
	call compile preprocessFileLineNumbers format ["overheat\external\logistic\lang\%1_lang.sqf", LOG_CFG_lANG];

	MONI_OBJECT	= compile preprocessFileLineNumbers "overheat\external\logistic\monitor\monitor_object.sqf";
	MONI_ACTION	= compile preprocessFileLineNumbers "overheat\external\logistic\monitor\monitor_action.sqf";
	LOG_OBJ_INIT = compile preprocessFileLineNumbers "overheat\external\logistic\object\init.sqf";
	LOG_LIFT_INIT = compile preprocessFileLineNumbers "overheat\external\logistic\lift\init.sqf";
	LOG_TOW_INIT = compile preprocessFileLineNumbers "overheat\external\logistic\tow\init.sqf";
