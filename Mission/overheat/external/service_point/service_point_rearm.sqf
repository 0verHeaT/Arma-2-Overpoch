...
private ["_vehicle","_args","_servicePoint","_costs","_magazineCount","_weapon","_type","_name","_weaponType","_weaponName","_turret","_magazines","_ammo","_textMissing","_wealth"];
...
if ((_costs select 1) > _wealth) exitWith {cutText [format["You need another %1 Gold Coins",(_costs select 1) - _wealth] ,"PLAIN DOWN"];};

player setVariable ["cashMoney",(_wealth - (_costs select 1)),true];
