...
_coinsRepairAir = 5400;
_coinsRepairVehicles = 2700;
_coinsRefuelVehicles = 900;
_coinsRefuelAir = 1800;
 
_coinsRearmSUV = 21600;
_coinsRearmAir = 21600;
_coinsRearmVehicles = 10800;
 
// -- End Single Currency Prices -- //
 
// general settings
_folder = "overheat\external\service_point\"; // folder where the service point scripts are saved, relative to the mission file
