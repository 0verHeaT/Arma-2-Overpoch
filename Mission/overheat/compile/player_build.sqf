...
_isBuildAdmin = (getPlayerUID player) in VGAdmins;
...
if(_isBuildAdmin) then {_canBuildOnPlot = true;};
//Item Check
...
if (_hasRequiredTools && _hasbuilditem) then {
	...
	if !(_classname in DZE_noRotate) then{
		s_player_setVectorsReset = player addaction ["Reset","overheat\compile\player_vectorChange.sqf","reset"];
		s_player_setVectorsForward = player addaction ["Pitch Forward","overheat\compile\player_vectorChange.sqf","forward"];
		s_player_setVectorsBack = player addaction ["Pitch Back","overheat\compile\player_vectorChange.sqf","back"];
		s_player_setVectorsLeft = player addaction ["Bank Left","overheat\compile\player_vectorChange.sqf","left"];
		s_player_setVectorsRight = player addaction ["Bank Right","overheat\compile\player_vectorChange.sqf","right"];
		s_player_setVectors1 = player addaction ["Increment by 1 degree","overheat\compile\player_vectorChange.sqf","1"];
		s_player_setVectors5 = player addaction ["Increment by 5 degrees","overheat\compile\player_vectorChange.sqf","5"];
		s_player_setVectors45 = player addaction ["Increment by 45 degrees","overheat\compile\player_vectorChange.sqf","45"];
		s_player_setVectors90 = player addaction ["Increment by 90 degrees","overheat\compile\player_vectorChange.sqf","90"];
	};
