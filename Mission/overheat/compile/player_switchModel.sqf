private ["_weapons","_backpackWpn","_backpackMag","_currentWpn","_backpackWpnTypes","_backpackWpnQtys","_countr","_class","_position","_dir","_currentAnim","_tagSetting","_playerUID","_countMags","_magazines","_primweapon","_secweapon","_newBackpackType","_muzzles","_oldUnit","_group","_newUnit","_playerObjName","_wpnType","_ismelee","_cId","_cHu"];
_class = _this;
...
_cHu = player getVariable["humanity",0];
...
_newUnit setVariable ["humanity",_cHu,true];
...
if !(canbuild) then {terminate SafezoneSpeedLimit;call safezone_start;};
