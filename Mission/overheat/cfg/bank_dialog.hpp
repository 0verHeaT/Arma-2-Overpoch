...
class BankDialog
{
	idd = 420000;
	movingenable = 0;
	onLoad = "uiNamespace setVariable ['BankDialog', _this select 0]";
	class Controls {
		...
		class RscTextT_1009: RscStructuredText
		{
			idc = 13003;
		...
		class RscShortcutButton_1700: RscShortcutButton
		{
			...
			h = 0.055016 * safezoneH;
			onButtonClick = "[(ctrlText 13000)] spawn sc_bankDespoit; ((ctrlParent (_this select 0)) closeDisplay 9000);";
		};
		class RscShortcutButton_1701: RscShortcutButton
		{
			...
			w = 0.0878939 * safezoneW;
			h = 0.055016 * safezoneH;
			onButtonClick = "[(ctrlText 13000)] spawn sc_bankWithdraw; ((ctrlParent (_this select 0)) closeDisplay 9000);";
		};
