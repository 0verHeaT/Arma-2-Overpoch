...
class GarageDialog
{
	...
	class Controls {
		class RscTextT_5000300: RscTextT	// Background
		{
			idc = -1;
		...
		class RscTextT_5000301: RscTextT	// Headline
		{
			idc = -1;
			text = "Virtual Garage";
			x = 0.316666 * safezoneW + safezoneX;
		...
		class RscListbox_5000302: RscListbox	//Listbox Vehicles nearby
		{
			idc = 5200;
		...
		class RscListbox_5000303: RscListbox	//Listbox Vehicles in Garage
		{
			idc = 5201;
		...
		class RscStructuredText_5000304: RscStructuredText //vehnear info
		{
			idc = 5202;
			x = 0.337500 * safezoneW + safezoneX;
		...
		class RscStructuredText_5000305: RscStructuredText // Vehicle stored INFO
		{
			idc = 5203;
			x = 0.508333 * safezoneW + safezoneX;
			y = 0.340740 * safezoneH + safezoneY;
...
class GarageDialogManage
{
	...
	class Controls {
		class RscTextT_5000400: RscTextT	// Background
		{
			idc = -1;
			x = 0.316666 * safezoneW + safezoneX;
			y = 0.266666 * safezoneH + safezoneY;
		...
		class RscTextT_5000401: RscTextT	// Headline
		{
			idc = -1;
		...
		class RscListbox_5000402: RscListbox	//Listbox Players Nearby
		{
			idc = 5204;
			x = 0.337500 * safezoneW + safezoneX;
			y = 0.385185 * safezoneH + safezoneY;
		...
		class RscListbox_5000403: RscListbox	//Listbox Friends
		{
			idc = 5205;
			x = 0.508333 * safezoneW + safezoneX;
			y = 0.385185 * safezoneH + safezoneY;
